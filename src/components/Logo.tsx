...
export function Logo(props: SVGProps<SVGSVGElement> & { size?: number; className?: string }) {
  ...
  return (
	...
	<g id="SVGRepo_iconCarrier">
		...
		<path d="M489.8 516.2m-14.5 0a14.5 14.5 0 1 0 29 0 14.5 14.5 0 1 0-29 0Z" fill="#004364"></path>
		<path d="M374.4 613.1m-14.5 0a14.5 14.5 0 1 0 29 0 14.5 14.5 0 1 0-29 0Z" fill="#004364"></path>
		<path d="M320.5 639.9m-14.5 0a14.5 14.5 0 1 0 29 0 14.5 14.5 0 1 0-29 0Z" fill="#004364"></path>
		<path d="M357.3 682.6m-14.5 0a14.5 14.5 0 1 0 29 0 14.5 14.5 0 1 0-29 0Z" fill="#004364"></path>
		<path d="M637 186.4m-14.5 0a14.5 14.5 0 1 0 29 0 14.5 14.5 0 1 0-29 0Z" fill="#004364"></path>
		<path d="M547.2 770.9m-14.5 0a14.5 14.5 0 1 0 29 0 14.5 14.5 0 1 0-29 0Z" fill="#004364"></path>
		<path d="M512 807.7m-14.5 0a14.5 14.5 0 1 0 29 0 14.5 14.5 0 1 0-29 0Z" fill="#004364"></path>
	</g>
</svg>
